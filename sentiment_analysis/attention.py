...
class MultiHeadDotProductAttention(Module):
  ...
  attention_init: Initializer = default_kernel_init
  ...
  def __call__(
    ...
    *,
    ...
    query, key, value = (
      dense(name='query', kernel_init=self.attention_init)(inputs_q),
      dense(name='key', kernel_init=self.attention_init)(inputs_k),
      dense(name='value', kernel_init=self.kernel_init)(inputs_v),
    )
